## Learning basic web-app design using JavaScript, HTML and CSS
### Project Aims
...
3. Code checking
    I got feedback on my code from my tutors and classmates. They suggested changes to make my code more readable and functional.
4. Structure and commenting 
    ...
    I also tried to structure it so that most variables are declared at the start of the code. 
